...
## Key Components
- `notebookETL.ipynb` — main ETL notebook with data processing, transformation, and practical notes.
...
## Work Summary
This work covers reading and transforming data using Databricks notebooks, designing a MongoDB collection schema, and documenting the architecture and practical challenges. The ETL process is built and explained inside `notebookETL.ipynb`, while the underlying data model and architecture are captured in the provided PNG diagrams.

## Practical Notes
- Section 3 practical challenges are documented in the notebook `notebookETL.ipynb` and in the separate file `section3_qa.md`.
- The notebook includes notes about the obstacles encountered, such as using serverless compute limitations, avoiding secret management, and adapting MongoDB usage in a free Databricks environment.
